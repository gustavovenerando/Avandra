...
export const siteArr = [
    ...
    },
    {
        ...
        productNameSelector: '#listing main > article:nth-child(INDEX) .productLink .nameCard',
        pricePixSelector: '#listing main > article:nth-child(INDEX) .productLink .priceCard',
        priceCreditSelector: '',
        soldOutSelector: '#listing main > article:nth-child(INDEX) .productLink .unavailablePricesCard',
        productEndpointSelector: '#listing main > article:nth-child(INDEX) .productLink',
    },
    {
        site: "gkinfostore",
        type: "gpu",
